...
from trl0.trl.trainer.orpo_trainer import ORPOTrainer
from trl0.trl.trainer.orpo_config import ORPOConfig
...
class ScriptArguments:
    ...
    learning_rate: Optional[float] = field(
        default=5e-6, metadata={"help": "the learning rate"}
    )
    ...
    po_type: Optional[str] = field(
        default="orpo", metadata={"help": "orpo, opo1, opo2"}
    )
